...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // d3.1 Create a variable that filters the metadata object with the desired sample number.
    ...
    // d3.3 Creat a variable that holds the washing frequency
    ...
    var slicedOTUids = otu_ids.slice(0, 10);
    var reversedOTUids = slicedOTUids.reverse();

    var yticks = reversedOTUids.map(id => "OTU_" + id);
...
// 3. Use Plotly to plot the data with the layout.
  ...
  // 5. Create the layout for the gauge chart.
    var gaugeLayout = { 
      ...
      font: {color: "dimgrey", family: "Arial"}
     };
